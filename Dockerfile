...
# Keep the terminal UI pointed at the prebuilt image copy so dashboard chat does
# not try to rebuild TUI assets on the persistent Railway volume at runtime.
